...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DMA_BITS_PER_SAMPLE" -parent ${JESD204_Framer_Configuration} -widget comboBox
  ...
  ipgui::add_param $IPINST -name "XBAR_ENABLE" -parent ${Datapath_Configuration} -widget checkBox
  ipgui::add_param $IPINST -name "DDS_TYPE" -parent ${Datapath_Configuration} -widget comboBox
  ipgui::add_param $IPINST -name "DDS_PHASE_DW" -parent ${Datapath_Configuration}
