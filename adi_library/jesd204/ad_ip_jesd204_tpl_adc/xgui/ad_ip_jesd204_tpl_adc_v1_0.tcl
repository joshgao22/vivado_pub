...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DMA_BITS_PER_SAMPLE" -parent ${JESD204_Deframer_Configuration} -widget comboBox
  ...
  ipgui::add_param $IPINST -name "PN7_ENABLE" -parent ${Datapath_Configuration} -widget checkBox
  ipgui::add_param $IPINST -name "PN15_ENABLE" -parent ${Datapath_Configuration} -widget checkBox
