...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "DAC_DDS_PHASE_DW" -parent ${Page_0}
...
proc update_PARAM_VALUE.DAC_DDS_PHASE_DW { PARAM_VALUE.DAC_DDS_PHASE_DW } {
	# Procedure called to update DAC_DDS_PHASE_DW when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.DAC_DDS_PHASE_DW { PARAM_VALUE.DAC_DDS_PHASE_DW } {
	# Procedure called to validate DAC_DDS_PHASE_DW
	return true
}
...
proc update_MODELPARAM_VALUE.DAC_DDS_PHASE_DW { MODELPARAM_VALUE.DAC_DDS_PHASE_DW PARAM_VALUE.DAC_DDS_PHASE_DW } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.DAC_DDS_PHASE_DW}] ${MODELPARAM_VALUE.DAC_DDS_PHASE_DW}
}
