...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "OR_STATUS" -parent ${Page_0}
  #Adding Group
...
proc update_PARAM_VALUE.OR_STATUS { PARAM_VALUE.OR_STATUS } {
	# Procedure called to update OR_STATUS when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.OR_STATUS { PARAM_VALUE.OR_STATUS } {
	# Procedure called to validate OR_STATUS
	return true
}
...
proc update_MODELPARAM_VALUE.OR_STATUS { MODELPARAM_VALUE.OR_STATUS PARAM_VALUE.OR_STATUS } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.OR_STATUS}] ${MODELPARAM_VALUE.OR_STATUS}
}
