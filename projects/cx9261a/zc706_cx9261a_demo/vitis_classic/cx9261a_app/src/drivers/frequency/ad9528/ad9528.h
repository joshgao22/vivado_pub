...
typedef enum {
	AD9528_CHANNEL_DIV = 0, PLL1_OUTPUT = 1, //VCXO frequency
	SYSREF = 2,
...
typedef enum {
	AD9528_LVDS = 0, AD9528_LVDS_BOOST = 1, AD9528_HSTL = 2
...
typedef struct {
	struct gpio_init_param *gpio_init_resetb;
	struct gpio_init_param *gpio_init_sysref_req;
