...
AD9361_InitParam ad9361_default_init_param = {
	/* Device selection */
	ID_AD9361,	// dev_sel
	/* Reference Clock */
	48000000UL,	//reference_clk_rate
	/* Base Configuration */
	...
	/* LO Control */
	4125000000UL,	//rx_synthesizer_frequency_hz *** adi,rx-synthesizer-frequency-hz
	4126000000UL,	//tx_synthesizer_frequency_hz *** adi,tx-synthesizer-frequency-hz
	1,				//tx_lo_powerdown_managed_enable *** adi,tx-lo-powerdown-managed-enable
	/* Rate & BW Control */
	{768000000, 192000000, 96000000, 48000000, 24000000, 24000000},// rx_path_clock_frequencies[6] *** adi,rx-path-clock-frequencies
	{768000000, 192000000, 96000000, 48000000, 24000000, 24000000},// tx_path_clock_frequencies[6] *** adi,tx-path-clock-frequencies
	...
	48000000UL,	//aux_adc_rate *** adi,aux-adc-rate
	/* AuxDAC Control */
