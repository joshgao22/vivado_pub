...
// ad9361-1
static struct spi_init_param ad9361_1_reg_spi_init = {
...
static struct gpio_init_param ad9361_1_reg_gpio_resetb_init = {
	.number = AD9361_1_RESET_B,
	.platform_ops = &xil_gpio_ops,
	.extra = &xil_gpio_param
};

struct ad9361_reg_init_param ad9361_1_reg_default_init_param = {
	/* SPI */
	.spi_init = &ad9361_1_reg_spi_init,
	.gpio_resetb = &ad9361_1_reg_gpio_resetb_init
};
...
//************************************************************
    ...
    status = ad9361_reg_write(dev, 0x0002, 0xA4);	// Setup Tx Digital Filters/ Channels
    status = ad9361_reg_write(dev, 0x0003, 0xA4);	// Setup Rx Digital Filters/ Channels
